...
Title:  surface_canopy_coefficient
 
Description: Populates the fields  <nodeID> and <value> (surface_canopy_coefficient)
...
try:
    def makeTable():
        ...
        arcpy.AddField_management(newTB,"Canopy","float")
        ...
        while count == 0:
            line = input.readline()
            data = line.split()
            if str(data[0]) == str("surface_canopy_coefficient"):
                count=+1
