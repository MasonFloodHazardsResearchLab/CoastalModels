...
Title:  sea_surface_height_above_geoid
 
Description: Populates the fields  <nodeID> and <value> (sea_surface_height_above_geoid)
...
try:
    def makeTable():
        ...
        arcpy.AddField_management(newTB,"Height","float")
        ...
        while count == 0:
            line = input.readline()
            data = line.split()
            if str(data[0]) == str("sea_surface_height_above_geoid"):
                count=+1
